...
class VerifyOtpCustomerScreen extends StatefulWidget {
  const VerifyOtpCustomerScreen({super.key, required this.onSuccess});
  final Function onSuccess;

  static MaterialPageRoute getRoute({required Function onSuccess}) {
    return MaterialPageRoute(
      builder: (_) => VerifyOtpCustomerScreen(onSuccess: onSuccess),
    );
  }

  @override
  _VerifyOtpCustomerScreenState createState() => _VerifyOtpCustomerScreenState();
}

class _VerifyOtpCustomerScreenState extends State<VerifyOtpCustomerScreen> {
  ...
  Future<void> verifyOtp() async {
    ...
    final response = await http.post(
      Uri.parse('http://10.0.2.2:8000/api/customer/verifyOTP'),
